...
const Cart = () => {
        ...
        {/* <div className="md:ml-0 sm:ml-0 xs:ml-0"> */}
          <div className="flex flex-row items-center mb-1 sm:w-80 xs:w-64">
            ...
            <div className="flex flex-col ml-4 lg:ml-4 md:ml-0 sm:ml-0 xs:ml-0 sm:w-96">
              ...
              <div className="w-10 mt-2 h-4 bg-black flex text-white items-center justify-center text-sm lg:w-10 lg:h-5 md:w-7 md:h-4 md xs:w-8 xs:h-3 xs:px-6 p-3 xs:p-2">
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <div className="ml-16 mr-16 mt-5 lg:ml-12 lg:mr-12 md:ml-10 md:mr-10 sm:ml-6 sm:mr-5 xs:ml-3 xs:mr-3" key={data.id}>
...
//     return (
//       <div
//       className="border h-52 w-full lg:max-w-3xl lg:h-48 md:max-w-2xl md:h-40 md:mt-0 sm:max-w-xl sm:h-36 xs:max-w-xl xs:h-36 flex justify-center items-center"
//       key={item.id}
//     >
//       <div className="ml-7 lg:ml-7 md:ml-0 sm:ml-0 xs:ml-0">
//         <div className="flex flex-row items-center mb-1 sm:w-80 xs:w-64">
//           <img
//             className="w-full object-cover mb-2 h-36 rounded-lg p-3 lg:w-full lg:h-36 md:w-96 md:h-32 sm:w-72 sm:h-24 sm:rounded-md xs:w-56 xs:h-20 xs:rounded-md"
//             src={item.food.imageFile}
//             alt={item.food.foodName}
//           />
//           <div className="flex flex-col ml-4 lg:ml-4 md:ml-0 sm:ml-0 xs:ml-0 sm:w-96">
...
//               {item.food.foodType}
//             </p>
//             <div className="w-10 mt-2 h-4 bg-black flex text-white items-center justify-center text-sm lg:w-10 lg:h-5 md:w-7 md:h-4 xs:w-8 xs:h-3 p-3 xs:p-2">
//               <p className="xs:text-sm xs:ml-1">3.3</p>
//               <FontAwesomeIcon
//                 className="text-sm ml-1 xs:text-sm xs:mr-1"
//                 icon={faStar}
...
//                     </span>
//                   </div>
//                   <span className="text-red-600 ml-2 lg:text-sm md:text-sm xs:text-sm xs:w-12 xs:ml-1 flex">
//                     {item.food.discount}% off
//                   </span>
//                 </>
//               )}
...
//         key={data.id}
//       >
//         {/* Modified the flex direction based on screen size */}
//         <div className="flex flex-col md:flex-row flex-wrap xl:flex-nowrap w-full">
//           <div className="flex flex-wrap m-4 w-full lg:m-4 md:m-2">
//             {userId && data}
//           </div>
//           {userId && cartItemCount > 0 ? (
//             <div className="h-4/5 shadow-lg mt-8 md:mt-0 md:ml-3 m-4 w-full md:w-2/3 lg:h-4/5 md:h-auto sm:w-full sm:h-auto xs:w-full xs:h-auto flex flex-col md:flex-row">
...
//                 <div className="flex justify-between items-center mt-4 md:flex-row xs:justify-center flex-col">
...
//                       createRazorpayOrder(payableAmount, "INR", "recept_id")
//                     }
//                     className="h-10 ml-4 mt-3 bg-blue-600 w-full text-white text-lg font-semibold rounded-sm lg:h-10 md:h-8 lg:text-lg md:text-sm sm:text-xs sm:h-7 xs:text-sm xs:ml-0"
//                   >
//                     {btnState}
//                   </button>
