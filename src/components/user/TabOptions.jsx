...
//     return (
//       <div
//         className="scroll-item w-full flex justify-center items-center flex-col pl-1 mt-4"
//         key={food.id}
//       >
//         <img
...
//           onClick={() => categoryHandler(food.foodCategory)}
//         />
...
//   return (
//     <div className="overflow-x-hidden ml-16 mr-16 mt-5 relative">
...
//             {foodItemsToDisplay}
//           </div>
//           <div className="scroll-arrow scroll-arrow-left" onClick={() => handleScroll("left")}>
//             <FontAwesomeIcon icon={faChevronLeft} />
//           </div>
//           <div className="scroll-arrow scroll-arrow-right" onClick={() => handleScroll("right")}>
//             <FontAwesomeIcon icon={faChevronRight} />
//           </div>
//           {foodCategories && show && (
//             <div className="flex justify-center rounded-md shadow p-3 flex-wrap mt-4">
//               {foodCategories.map((food) => (
//                 <Link to={`/restaurant/${food.restaurant.id}`} key={food.id}>
//                   <div
